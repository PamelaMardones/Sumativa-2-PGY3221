...
from .views import add_to_cart, cart, checkout, home, actualizar,juegos_mesa, login_view,magic,pokemon,register, remove_from_cart,yugioh, logout_view, update, search, pokedex
